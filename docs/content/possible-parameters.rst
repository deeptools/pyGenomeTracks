...
This table is available as csv `here<https://raw.githubusercontent.com/deeptools/pyGenomeTracks/master/docs/content/all_default_properties.csv>`_.

.. include:: all_default_properties_rst.txt

Some parameters can take only discrete values.

They are summarized here:

.. include:: all_possible_properties.txt
