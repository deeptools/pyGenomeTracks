...
def test_plot_tracks_with_hic():
    ...
    [hic matrix]
    file = Li_et_al_2015.h5
    title = depth=250000; transform=log1p; orientation=inverted; colormap=PrRd; min_value=5; max_value=70
    min_value = 5
    max_value = 70
    depth = 250000
    #transform = log1p
    ...
    [hic matrix]
    file = Li_et_al_2015.h5
    title = depth=300000; transform=log1p; colormap Blues (TADs: overlay previous=yes)
    colormap = Blues
    min_value = 10
    max_value = 150
    depth = 300000
