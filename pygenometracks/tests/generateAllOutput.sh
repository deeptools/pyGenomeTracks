...
bin/pgt --tracks pygenometracks/tests/test_data/scale_bar_xboundary.ini --region X:3000000-3600000 --trackLabelFraction 0.2 --width 38 --dpi 130 -o pygenometracks/tests/test_data/master_scale_bar_xboundary.png
bin/pgt --tracks pygenometracks/tests/test_data/scale_bar_xboundary.ini --region X:3000000-3600000 --trackLabelFraction 0.2 --width 38 --dpi 130 --decreasingXAxis -o pygenometracks/tests/test_data/master_scale_bar_xboundary_dec.png
bin/pgt --tracks pygenometracks/tests/test_data/scale_bar_xboundary.ini --region X:2000000000-2500000000 --trackLabelFraction 0.2 --width 38 --dpi 130 -o pygenometracks/tests/test_data/master_scale_bar_xboundary_outside.png
bin/pgt --tracks pygenometracks/tests/test_data/scale_bar_xboundary.ini --region X:3199500-3201000 --trackLabelFraction 0.2 --width 38 --dpi 130 -o pygenometracks/tests/test_data/master_scale_bar_xboundary_superzoom.png
