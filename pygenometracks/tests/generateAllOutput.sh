...
bin/pgt --tracks ./pygenometracks/tests/test_data/bed_and_gtf_tracks.ini --region X:3050000-3100000 --trackLabelFraction 0.2 --width 38 --dpi 130 -o ./pygenometracks/tests/test_data/master_bed_and_gtf_zoom.png
bin/pgt --tracks ./pygenometracks/tests/test_data/bed_and_gtf_tracks_labels_in_margin.ini --region X:3050000-3100000 --trackLabelFraction 0.2 --width 38 --dpi 130 -o ./pygenometracks/tests/test_data/master_bed_and_gtf_zoom_lim.png
bin/pgt --tracks ./pygenometracks/tests/test_data/bed_and_gtf_tracks_labels_in_margin.ini --region X:3050000-3100000 --trackLabelFraction 0.2 --width 38 --dpi 130 --trackLabelHAlign right -o ./pygenometracks/tests/test_data/master_bed_and_gtf_zoom_lim_ral.png
...
bin/pgt --tracks ./pygenometracks/tests/test_data/bed_all_labels_inside.ini --region X:3050000-3100000 --trackLabelFraction 0.2 --width 38 --dpi 130 -o ./pygenometracks/tests/test_data/master_bed_all_label_inside.png
