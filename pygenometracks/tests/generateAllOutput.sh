...
bin/pgt --tracks pygenometracks/tests/test_data/first_maf_seq_hg19.ini --region 9:128093930-128093970 --trackLabelFraction 0.2 --width 38 --dpi 10 -o pygenometracks/tests/test_data/master_first_maf_seq_hg19.pdf
